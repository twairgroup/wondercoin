Contributing to Wondercoin Core
============================

The Wondercoin Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "Wondercoin Core
...
Before you start contributing, familiarize yourself with the Wondercoin Core build
system and tests. Refer to the documentation in the repository on how to build
Wondercoin Core and how to run the unit tests, functional tests, and fuzz tests.

There are many open issues of varying difficulty waiting to be fixed.
If you're looking for somewhere to start contributing, check out the
[good first issue](https://github.com/wondercoin/wondercoin/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or changes that are
[up for grabs](https://github.com/wondercoin/wondercoin/issues?utf8=%E2%9C%93&q=label%3A%22Up+for+grabs%22).
Some of them might no longer be applicable. So if you are interested, but
unsure, you might want to leave a comment on the issue first.

You may also participate in the weekly
[Wondercoin Core PR Review Club](https://wondercoincore.reviews/) meeting.
...
Most communication about Wondercoin Core development happens on IRC, in the
`#wondercoin-core-dev` channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/wondercoin-core-dev/](http://www.erisian.com.au/wondercoin-core-dev/)
and [http://gnusha.org/wondercoin-core-dev/](http://gnusha.org/wondercoin-core-dev/).

Discussion about codebase improvements happens in GitHub issues and pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/wondercoin-dev)
...
For GUI-related issues or pull requests, the https://github.com/wondercoin-core/gui repository should be used.
For all other issues and pull requests, the https://github.com/wondercoin/wondercoin node repository should be used.
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to wondercoin-qt
...
fork of Wondercoin Core copies the merge. Instead, make any username mentions in a
subsequent comment to the PR.

### Translation changes

Note that translations should not be submitted as pull requests. Please see
[Translation Process](https://github.com/wondercoin/wondercoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Wondercoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Wondercoin
Network Protocol consensus changes.

Whether a pull request is merged into Wondercoin Core rests with the project merge
...
Patches that change Wondercoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Wondercoin consensus, it must have been
...
https://github.com/wondercoin/wondercoin/pull/16189).

Also see the [backport.py script](
https://github.com/wondercoin-core/wondercoin-maintainer-tools#backport).

Release Policy
--------------

The project leader is the release manager for each Wondercoin Core release.
