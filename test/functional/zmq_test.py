...
from test_framework.test_framework import WondercoinTestFramework, SkipTest
from test_framework.util import (assert_equal,
                                 bytes_to_hex_str,
                                 hash256,
                                )

class ZMQTest (WondercoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that wondercoin has been built with ZMQ enabled
