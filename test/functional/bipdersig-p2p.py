...
class BIP66Test(WondercoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # wondercoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and wondercoind produces more specific reject
            # reasons.
