...
# The block reward of coinbaseoutput.nValue (50) WDC/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 WDC/block.
BLOCKS = 101
...
class TestWondercoinCli(WondercoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `wondercoin-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and wondercoin-cli getwalletinfo return expected wallet info")
            ...
            # Mine a block to confirm; adds a block reward (50 WDC) to the default wallet.
            ...
            # Test wondercoin-cli -generate with -rpcwallet in multiwallet mode.
