...
class P2PPermissionsTests(WondercoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].wondercoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].wondercoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
