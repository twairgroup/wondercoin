...
Verify that a wondercoind node can use an external signer command.
...
class RPCSignerTest(WondercoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart wondercoind with -signer=<cmd>',
