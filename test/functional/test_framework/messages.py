...
"""Wondercoin test framework primitive and message structures

CBlock, CTransaction, CBlockHeader, CTxIn, CTxOut, etc....:
    data structures that should map to corresponding structures in
    wondercoin/primitives
...
COIN = 100000000  # 1 wdc in satoshis
...
# Objects that map to wondercoind objects, which can be serialized/deserialized


class CAddress:
    __slots__ = ("net", "ip", "nServices", "port", "time")

    # see https://github.com/wondercoin/bips/blob/master/bip-0155.mediawiki
    NET_IPV4 = 1
...
class CBlockLocator:
    ...
    def serialize(self):
        r = b""
        r += struct.pack("<i", 0)  # Wondercoin Core ignores version field. Set it to 0.
...
class CTransaction:
    ...
    def deserialize(self, f):
        ...
        if len(self.vin) == 0:
            ...
            # matches the implementation in wondercoind
            if (flags != 0):
                self.vin = deser_vector(f, CTxIn)
...
class msg_version:
    ...
    def deserialize(self, f):
        ...
        # But, unconditionally check it to match behaviour in wondercoind
        try:
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in wondercoind indicates these should be deserialized as blocks
