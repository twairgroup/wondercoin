...
class TestShell:
    """Wrapper Class for WondercoinTestFramework.

    The TestShell class extends the WondercoinTestFramework
    ...
    class __TestShell(WondercoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by WondercoinTestFramework child class.
            self.num_nodes = 1
