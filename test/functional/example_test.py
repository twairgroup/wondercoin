...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the WondercoinTestFramework
    pass

class ExampleTest(WondercoinTestFramework):
    # Each functional test is a subclass of the WondercoinTestFramework class.
    ...
    def custom_method(self):
        ...
        WondercoinTestFramework class so other tests can use it."""
