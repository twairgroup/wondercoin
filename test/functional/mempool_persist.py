...
By default, wondercoind will dump mempool on shutdown and
...
class MempoolPersistTest(WondercoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent wondercoind from writing mempool.dat to disk. Verify that `savemempool` fails")
