...
"""Verify that starting wondercoin with -h works as expected."""

from test_framework.test_framework import WondercoinTestFramework
from test_framework.util import assert_equal

class HelpTest(WondercoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start wondercoin with -h for help text")
        ...
        self.log.info("Start wondercoin with -version for version information")
        ...
        self.log.info("Start wondercoind with -fakearg to make sure it does not start")
