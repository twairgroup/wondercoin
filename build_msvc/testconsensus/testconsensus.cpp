...
// wondercoin includes.
#include <..\src\script\wondercoinconsensus.h>
...
int main()
{
    std::cout << "wondercoinconsensus version: " << wondercoinconsensus_version() << std::endl;
    ...
    auto op0Result = wondercoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, wondercoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
