...
libs = [
    'libwondercoin_cli',
    'libwondercoin_common',
    'libwondercoin_crypto',
    'libwondercoin_server',
    'libwondercoin_util',
    'libwondercoin_wallet_tool',
    'libwondercoin_wallet',
    'libwondercoin_zmq',
    'bench_wondercoin',
    'libtest_util',
]
...
def main():
    parser = argparse.ArgumentParser(description='Wondercoin-core msbuild configuration initialiser.')
        ...
        with open(vcxproj_filename + '.in', 'r', encoding='utf-8') as vcxproj_in_file:
            with open(vcxproj_filename, 'w', encoding='utf-8') as vcxproj_file:
                vcxproj_file.write(vcxproj_in_file.read().replace(
                    '@SOURCE_FILES@\n', content))
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/wondercoin_config.h'), os.path.join(SOURCE_DIR, 'config/wondercoin-config.h'))
