...
This document provides guidelines for internationalization of the Wondercoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `wondercoin_en.ts` remains unchanged.
