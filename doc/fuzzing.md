# Fuzzing Wondercoin Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing Wondercoin Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
# libFuzzer" on https://github.com/wondercoin/wondercoin/blob/master/doc/fuzzing.md#macos-hints-for-libfuzzer
$ make
...
[`process_message`](https://github.com/wondercoin/wondercoin/blob/master/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/wondercoin/wondercoin/blob/master/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/wondercoin/wondercoin/tree/master/src/test/fuzz).
...
The project's collection of seed corpora is found in the [`wondercoin-core/qa-assets`](https://github.com/wondercoin-core/qa-assets) repo.

To fuzz `process_message` using the [`wondercoin-core/qa-assets`](https://github.com/wondercoin-core/qa-assets) seed corpus:

```sh
$ git clone https://github.com/wondercoin-core/qa-assets
...
If you find coverage increasing inputs when fuzzing you are highly encouraged to submit them for inclusion in the [`wondercoin-core/qa-assets`](https://github.com/wondercoin-core/qa-assets) repo.

Every single pull request submitted against the Wondercoin Core repo is automatically tested against all inputs in the [`wondercoin-core/qa-assets`](https://github.com/wondercoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Wondercoin Core more robust.
...
with certain assembly code from Wondercoin Core's code. See [developer notes on sanitizers](https://github.com/wondercoin/wondercoin/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing Wondercoin Core using afl++

## Quickstart guide

To quickly get started fuzzing Wondercoin Core using [afl++](https://github.com/AFLplusplus/AFLplusplus):
...
# Fuzzing Wondercoin Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing Wondercoin Core using [Honggfuzz](https://github.com/google/honggfuzz):
...
## Fuzzing the Wondercoin Core P2P layer using Honggfuzz NetDriver

Honggfuzz NetDriver allows for very easy fuzzing of TCP servers such as Wondercoin
Core without having to write any custom fuzzing harness. The `wondercoind` server
...
```sh
$ mkdir wondercoin-honggfuzz-p2p/
$ cd wondercoin-honggfuzz-p2p/
$ git clone https://github.com/wondercoin/wondercoin
$ cd wondercoin/
$ ./autogen.sh
$ git clone https://github.com/google/honggfuzz
...
$ git apply << "EOF"
diff --git a/src/wondercoind.cpp b/src/wondercoind.cpp
index 455a82e39..2faa3f80f 100644
--- a/src/wondercoind.cpp
+++ b/src/wondercoind.cpp
