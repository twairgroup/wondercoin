Wondercoin Core version 0.9.4 is now available from:

  https://wondercoin.org/bin/0.9.4/
...
this update is incompatible with the Wondercoin system and could lead to consensus
forks.

Wondercoin Core released binaries from https://wondercoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~wondercoin/+archive/ubuntu/wondercoin
- A third-party or self-compiled Wondercoin Core

upgrade to Wondercoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
