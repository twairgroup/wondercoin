Wondercoin Core version *0.14.3* is now available from:

  <https://wondercoin.org/bin/wondercoin-core-0.14.3/>
...
Since 0.14.0 the approximate transaction fee shown in Wondercoin-Qt when using coin
...
- #10451 `3612219` contrib/init/wondercoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
