Wondercoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/wondercoin/files/Wondercoin/wondercoin-0.5.4/
...
http://gitorious.org/wondercoin/wondercoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Wondercoin-Qt notifications under Growl 1.3.
Increase required age of Wondercoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxWondercoin properly when installing Wondercoin-Qt over it. (Windows)
