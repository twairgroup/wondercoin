Wondercoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/wondercoin/files/Wondercoin/wondercoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Wondercoin
...
New/changed settings (command-line or wondercoin.conf file)
--------------------------------------------------------
