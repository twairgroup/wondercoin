Wondercoin Core version 0.13.2 is now available from:

  <https://wondercoin.org/bin/wondercoin-core-0.13.2/>
...
- #8908 `4a974b2` Update wondercoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow wondercoin-tx to create v2 transactions (wdcdrak)
