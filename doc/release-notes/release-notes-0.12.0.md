Wondercoin Core version 0.12.0 is now available from:
...
Wondercoin Core 0.12 will have a strict maximum size on the mempool. The
...
Then, to tunnel a SSL connection on 28666 to a RPC server bound on localhost on port 18666 do:

    stunnel -d 28666 -r 127.0.0.1:18666 -p stunnel.pem -P ''
...
caching. A sample config for apache2 could look like:
    ...
    <Location /wondercoinrpc>
        ProxyPass http://127.0.0.1:8666/
        ProxyPassReverse http://127.0.0.1:8666/
