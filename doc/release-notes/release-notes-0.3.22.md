Download URL: https://sourceforge.net/projects/wondercoin/files/Wondercoin/wondercoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 WDC fee schedule (users still pay 0.01 WDC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #wondercoin00 - #wondercoin99
