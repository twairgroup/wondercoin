Wondercoin Core version 0.10.4 is now available from:

  <https://wondercoin.org/bin/wondercoin-core-0.10.4/>
...
- #6953 `43c2789` Split wondercoin-tx into its own package
- #6953 `dfe0d4d` Include wondercoin-tx binary on Debian/Ubuntu
