Wondercoin Core version 0.9.2.1 is now available from:

  https://wondercoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 WDC to 0.01 WDC
...
- Fix "Start wondercoin on system login"
