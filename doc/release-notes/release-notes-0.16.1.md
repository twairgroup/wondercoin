Wondercoin Core version 0.16.1 is now available from:

  <https://wondercoincore.org/bin/wondercoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting wondercoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure wondercoind processes are cleaned up when tests end (sdaftuar)
