...
Wondercoin Core version 0.19.1 is now available from:

  <https://wondercoincore.org/bin/wondercoin-core-0.19.1/>
...
From Wondercoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Wondercoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Wondercoin Core does not yet change appearance when
...
- #17488 fix "wondercoind already running" warnings on macOS (fanquake)
