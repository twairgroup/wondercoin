...
#ifndef WONDERCOIN_WALLET_WALLETUTIL_H
#define WONDERCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! wondercoin from opening the wallet, thinking it was newly created, and
...
#endif // WONDERCOIN_WALLET_WALLETUTIL_H
