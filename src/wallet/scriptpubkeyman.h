...
#ifndef WONDERCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define WONDERCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Wondercoin Core wallet was originally a collection of unrelated private
...
#endif // WONDERCOIN_WALLET_SCRIPTPUBKEYMAN_H
