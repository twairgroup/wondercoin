...
#ifndef WONDERCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define WONDERCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // WONDERCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
