...
#ifndef WONDERCOIN_WALLET_ISMINE_H
#define WONDERCOIN_WALLET_ISMINE_H
 ...
 * https://github.com/wondercoin/wondercoin/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
...
#endif // WONDERCOIN_WALLET_ISMINE_H
