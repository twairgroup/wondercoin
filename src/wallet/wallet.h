...
#ifndef WONDERCOIN_WALLET_WALLET_H
#define WONDERCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this wondercoin node, and set to 0 for transactions that were created
...
#endif // WONDERCOIN_WALLET_WALLET_H
