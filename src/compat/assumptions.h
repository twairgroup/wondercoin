...
#ifndef WONDERCOIN_COMPAT_ASSUMPTIONS_H
#define WONDERCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Wondercoin cannot be compiled without assertions."
#endif
...
#endif // WONDERCOIN_COMPAT_ASSUMPTIONS_H
