...
#ifndef WONDERCOIN_NET_H
#define WONDERCOIN_NET_H
 ...
 * src/qt/guiutil.cpp and src/wondercoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Wondercoin’s Peer-to-Peer Network")
