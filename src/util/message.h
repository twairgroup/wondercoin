...
#ifndef WONDERCOIN_UTIL_MESSAGE_H
#define WONDERCOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's wondercoin address, it must refer to a public key.
...
#endif // WONDERCOIN_UTIL_MESSAGE_H
