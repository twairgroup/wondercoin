 ...
 * between wondercoind, and wondercoin-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("wondercoin-shutoff");
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), WONDERCOIN_PID_FILENAME));
#endif
...
std::string LicenseInfo()
{
    ...
    const std::string URL_WEBSITE = "<https://wondercoincore.org>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("wondercoin-loadblk");
...
/** Sanity checks
 *  Ensure that Wondercoin is running in a usable environment with all
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Wondercoin version %s\n", FormatFullVersion());
}
