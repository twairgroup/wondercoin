...
#ifndef WONDERCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define WONDERCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@wondercoin.
 *
 ...
 *
 * The chacha20-poly1305@wondercoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@wondercoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@wondercoin are relatively fast in
...
#endif // WONDERCOIN_CRYPTO_CHACHA_POLY_AEAD_H
