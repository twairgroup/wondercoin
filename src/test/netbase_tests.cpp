...
{
    BOOST_CHECK(TestSplitHost("www.wondercoincore.org", "www.wondercoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.wondercoincore.org]", "www.wondercoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.wondercoincore.org:80", "www.wondercoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.wondercoincore.org]:80", "www.wondercoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("::8888", "::8888", 0));
    BOOST_CHECK(TestSplitHost(":8888", "", 8888));
    BOOST_CHECK(TestSplitHost("[]:8888", "", 8888));
