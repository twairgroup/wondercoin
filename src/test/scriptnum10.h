...
#ifndef WONDERCOIN_TEST_SCRIPTNUM10_H
#define WONDERCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Wondercoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // WONDERCOIN_TEST_BIGNUM_H
