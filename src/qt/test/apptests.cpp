...
//! Entry point for WondercoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &WondercoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for WondercoinGUI tests.
void AppTests::guiTests(WondercoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &WondercoinGUI::consoleShown, this, &AppTests::consoleTests);
