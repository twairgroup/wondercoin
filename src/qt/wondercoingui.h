...
#ifndef WONDERCOIN_QT_WONDERCOINGUI_H
#define WONDERCOIN_QT_WONDERCOINGUI_H
...
/**
  Wondercoin GUI main class. This class represents the main window of the Wondercoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class WondercoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit WondercoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~WondercoinGUI();
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Wondercoin Transaction from file or clipboard */
...
#endif // WONDERCOIN_QT_WONDERCOINGUI_H
