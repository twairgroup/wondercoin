    ...
    platformStyle(_platformStyle)
{
    ...
    // normal wondercoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying wondercoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &WondercoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
