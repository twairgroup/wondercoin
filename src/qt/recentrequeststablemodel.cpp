    ...
    if(role == Qt::DisplayRole || role == Qt::EditRole)
    {
        ...
        case Amount:
            if (rec->recipient.amount == 0 && role == Qt::DisplayRole)
                ...
                return WondercoinUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount, false, WondercoinUnits::separatorNever);
            else
...
{
    return (this->walletModel->getOptionsModel() != nullptr) ? tr("Requested") + " ("+WondercoinUnits::name(this->walletModel->getOptionsModel()->getDisplayUnit()) + ")" : "";
}
