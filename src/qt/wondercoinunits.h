...
#ifndef WONDERCOIN_QT_WONDERCOINUNITS_H
#define WONDERCOIN_QT_WONDERCOINUNITS_H
...
/** Wondercoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class WondercoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit WondercoinUnits(QObject *parent);

    /** Wondercoin units.
      @note Source: https://en.wondercoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        WDC,
...
typedef WondercoinUnits::Unit WondercoinUnit;

#endif // WONDERCOIN_QT_WONDERCOINUNITS_H
