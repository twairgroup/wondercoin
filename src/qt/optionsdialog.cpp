    ...
    mapper(nullptr)
{
    ...
    ui->wondercoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->wondercoinAtStartup);
    ...
    ui->wondercoinAtStartup->setToolTip(ui->wondercoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->wondercoinAtStartup->setText(ui->wondercoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openWondercoinConfButton->setToolTip(ui->openWondercoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new WondercoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->wondercoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openWondercoinConfButton_clicked()
{
