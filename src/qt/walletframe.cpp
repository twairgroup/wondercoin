...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, WondercoinGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &WondercoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &WondercoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &WondercoinGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &WondercoinGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &WondercoinGUI::updateWalletStatus);
    connect(gui, &WondercoinGUI::setPrivacy, walletView, &WalletView::setPrivacy);
