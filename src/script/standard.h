...
#ifndef WONDERCOIN_SCRIPT_STANDARD_H
#define WONDERCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a wondercoin address
 */
...
/**
 * Generate a Wondercoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // WONDERCOIN_SCRIPT_STANDARD_H
