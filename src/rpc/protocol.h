...
#ifndef WONDERCOIN_RPC_PROTOCOL_H
#define WONDERCOIN_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in wondercoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Wondercoin is not connected
...
#endif // WONDERCOIN_RPC_PROTOCOL_H
