...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the wondercoin repository."
  exit 1
fi
...
# See https://github.com/wondercoin/wondercoin/issues/16064
...
echo 'When compiling wondercoind, run `./configure` in the following way:'
echo
