...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef WONDERCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define WONDERCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the wondercoin network\n')
    ...
    g.write('#endif // WONDERCOIN_CHAINPARAMSSEEDS_H\n')
