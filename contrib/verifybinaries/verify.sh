...
###   wondercoin.ca and wondercoin.ca and compares them.
...
RCSUBDIR="test"
HOST1="https://wondercoin.ca"
HOST2="https://wondercoin.ca"
BASEDIR="/bin/"
...
if [ $? -ne 0 ]; then
   echo "wondercoin.ca failed to provide signature file, but wondercoin.ca did?"
   echo "wget output:"
   echo "$WGETOUT"|sed 's/^/\t/g'
...
if [ "$SIGFILEDIFFS" != "" ]; then
   echo "wondercoin.ca and wondercoin.ca signature files were not equal?"
