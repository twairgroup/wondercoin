...
def main(args):
    ...
    if not success:
        print("wondercoin.org failed to provide signature file, "
              "but wondercoincore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("wondercoin.org and wondercoincore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Wondercoin Core binary release "
