...
This directory contains the files necessary to perform bootstrappable Wondercoin
Core builds.
...
From the top of a clean Wondercoin Core repository:
...
To use dongcarl's substitute server for Wondercoin Core builds after having
