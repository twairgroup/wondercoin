...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Wondercoin
else
  DOCKER_EXEC echo \> \$HOME/.wondercoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/wondercoin/wondercoin/pull/18288#discussion_r433189350 for
  # details.
